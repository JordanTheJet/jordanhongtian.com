...
$listObject = aws cloudfront list-distributions --output text --query "DistributionList.Items[].{DistributionId: Id, OriginDomainName: Origins.Items[0].DomainName}[?contains(OriginDomainName, 'jordanhongtian.com'||'www.jordanhongtian.com')]"
